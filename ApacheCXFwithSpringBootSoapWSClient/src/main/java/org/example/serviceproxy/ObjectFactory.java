...
public class ObjectFactory {
    ...
    private final static QName _AddProduct_QNAME = new QName("http://service.example.org/", "addProduct");
    private final static QName _AddProductResponse_QNAME = new QName("http://service.example.org/", "addProductResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://service.example.org/", name = "addProduct")
     ...
     */
    @XmlElementDecl(namespace = "http://service.example.org/", name = "addProductResponse")
