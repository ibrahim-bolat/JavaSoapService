...
public interface ProductService {
    ...
    @WebMethod
    @RequestWrapper(localName = "addProduct", targetNamespace = "http://service.example.org/", className = "org.example.serviceproxy.AddProduct")
    @ResponseWrapper(localName = "addProductResponse", targetNamespace = "http://service.example.org/", className = "org.example.serviceproxy.AddProductResponse")
    @WebResult(name = "return", targetNamespace = "")
    public org.example.serviceproxy.Product addProduct(
